...
| ------------------------------------------------------------------ | ------------------------------------------- | ---------- |
| [terraform](https://developer.hashicorp.com/terraform/install)     | Generating plans for fixtures               | 1.9.8      |
| [conftest](https://www.conftest.dev/install/)                      | Running policies and rego unit tests        | 0.56.0     |
| [opa](https://www.openpolicyagent.org/docs/latest/#running-opa)    | Extracting METADATA for docs generation     | 0.70.0     |
...
Updates are grouped by category, raised on Monday mornings (UTC), and use
`chore(deps): ...` commit messages so they stay out of the user-facing
changelog generated by release-please. **Renovate must be enabled on the repo
via the [GitHub App](https://github.com/apps/renovate) for the config to
take effect.**
