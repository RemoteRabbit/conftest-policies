...
| [opa](https://www.openpolicyagent.org/docs/latest/#running-opa)    | Extracting METADATA for docs generation     | <!-- renovate: datasource=github-releases depName=open-policy-agent/opa -->1.18.2 |
